export const COLLECTIONS = [
  ...
  },
  {
    id: 'backdooms',
    title: 'Backdooms',
    studio: 'Kuber Mehta / Backdooms contributors',
    year: 'Pinned Canvas runtime',
    format: 'Bundled independent runtime',
    genre: 'First-Person Horror Survival',
    duration: 'Endless procedural survival run',
    maps: 'Locally generated Backrooms-style maze',
    status: 'Free / bundled',
    license: 'MIT source · local package removes upstream tracking and third-party music',
    artwork: 'assets/screenshots/backdooms-runtime.webp',
    artworkCredit: 'Gameplay screenshot: RetroPlay local Backdooms browser runtime',
    description: 'A complete existing open-source first-person horror survival game, bundled from Backdooms. Move through a procedural Backrooms-style maze, turn toward threats, use limited ammunition and endure an escalating pursuit—fully local with keyboard, PSP touch controls, gamepad support and fullscreen, without an account, upload, server, remote tracking or external game data. RetroPlay ships the MIT-licensed procedural runtime only; upstream music and media are intentionally excluded.',
    playable: true,
    runtimePath: 'backdooms.html',
    runtimeLabel: 'Launch Backdooms',
    catalogState: 'UPSTREAM OPEN-SOURCE RUNTIME',
  },
  {
    id: 'astray',
