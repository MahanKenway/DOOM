export const COLLECTIONS = [
  ...
  },
  {
    ...
    format: 'Bundled independent runtime',
    genre: 'Experimental',
    duration: 'Three landing missions',
    maps: 'Local gravity, fuel and landing-pad missions',
    status: 'Free / bundled',
    license: 'RetroPlay original runtime · non-commercial platform deployment',
    artwork: 'assets/screenshots/orbit-lander-runtime.webp',
    artworkCredit: 'Gameplay screenshot: RetroPlay local Orbit Lander runtime',
    description: 'A precision lunar-landing challenge built for RetroPlay. Balance thrust, tilt, fuel and surface velocity across three local physics missions with keyboard, PSP-style touch controls, gamepad support and fullscreen from first load—no upload, account or external game data required.',
    playable: true,
    runtimePath: 'orbit-lander.html',
    runtimeLabel: 'Launch Orbit Lander',
    catalogState: 'INDEPENDENT RUNTIME',
  },
  {
    id: 'skyline-sprint',
    ...
    studio: 'RetroPlay',
    year: 'Original WASM-4 cartridge',
    format: 'Bundled independent runtime',
    genre: 'Racing',
    duration: 'Endless arcade score runs',
    maps: 'Local generated skyline traffic',
    status: 'Free / bundled',
    license: 'RetroPlay original cartridge · non-commercial platform deployment',
    artwork: 'assets/screenshots/skyline-sprint-runtime.webp',
    artworkCredit: 'Gameplay screenshot: RetroPlay local Skyline Sprint runtime',
    description: 'An original fantasy-console road racer built as a self-contained WASM-4 cartridge. Steer around shifting traffic, time the boost and chase a higher score with keyboard, PSP-style touch controls, gamepad support and fullscreen—no upload, account, WebGL requirement or external game data required.',
    playable: true,
    runtimePath: 'skyline-sprint.html',
    runtimeLabel: 'Launch Skyline Sprint',
    catalogState: 'INDEPENDENT RUNTIME',
  },
  {
    id: 'comet-breaker',
    ...
    format: 'Bundled independent runtime',
    genre: 'Arcade Puzzle',
    duration: 'Three-life brick-breaker runs',
    maps: 'Local multicolour brick fields',
    status: 'Free / bundled',
    license: 'RetroPlay original cartridge · non-commercial platform deployment',
    artwork: 'assets/screenshots/comet-breaker-runtime.webp',
    artworkCredit: 'Gameplay screenshot: RetroPlay local Comet Breaker runtime',
    description: 'An original fantasy-console brick breaker built as a self-contained WASM-4 cartridge. Launch the comet, control rebounds and clear the field with keyboard, PSP-style touch controls, gamepad support and fullscreen—no upload, account, WebGL requirement or external game data required.',
    playable: true,
    runtimePath: 'comet-breaker.html',
    runtimeLabel: 'Launch Comet Breaker',
    catalogState: 'INDEPENDENT RUNTIME',
  },
  {
    id: 'vector-putt-3d',
    title: 'Vector Putt 3D',
    studio: 'RetroPlay',
    year: 'Original browser runtime',
    format: 'Bundled independent runtime',
    genre: 'Experimental',
    duration: 'Six physics mini-golf courses · Collection 01',
    maps: 'Local slopes, water hazards and moving-gate courses',
    status: 'Free / bundled',
    license: 'RetroPlay original runtime · non-commercial platform deployment',
    artwork: 'assets/screenshots/vector-putt-runtime.webp',
    artworkCredit: 'Gameplay screenshot: RetroPlay local Vector Putt runtime',
    description: 'A compact mini-golf physics game built for RetroPlay. Line up each shot, manage power, use the slope, time moving gates and avoid water across six local courses in Collection 01, with PSP-style touch controls, gamepad support and fullscreen from first load—no upload, account or external game data required.',
    playable: true,
    runtimePath: 'vector-putt.html',
    runtimeLabel: 'Launch Vector Putt',
    catalogState: 'INDEPENDENT RUNTIME',
  },
  {
    id: 'hexgl',
