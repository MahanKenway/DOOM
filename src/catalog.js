export const COLLECTIONS = [
  ...
  },
  {
    ...
    format: 'Bundled independent runtime',
    genre: 'Experimental',
    duration: 'Three physics mini-golf courses',
    maps: 'Local obstacle, slope and hazard courses',
    status: 'Free / bundled',
    ...
    description: 'A compact mini-golf physics game built for RetroPlay. Line up each shot, manage power, use the slope and avoid water through three local courses, with PSP-style touch controls, gamepad support and fullscreen from first load—no upload, account or external game data required.',
    playable: true,
