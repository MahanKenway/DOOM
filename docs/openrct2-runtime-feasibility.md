# OpenRCT2 runtime feasibility for RetroPlay

**Status:** Not eligible for addition under RetroPlay’s current no-upload, fully bundled game-data policy.
